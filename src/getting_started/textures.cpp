...
void getting_started_textures()
{
    ...
    Shader ourShader("res/shader/getting_started_textures.vs", "res/shader/getting_started_textures.fs"); // you can name your shader files however you like
